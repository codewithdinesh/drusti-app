...
public class OtpView extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            context.getTheme().resolveAttribute(R.attr.colorOnSecondary,
                    outValue, true);
            final int colorDark = outValue.data;
            mColors[1] = colorDark;

            context.getTheme().resolveAttribute(R.color.gray_200,
                    outValue, true);
